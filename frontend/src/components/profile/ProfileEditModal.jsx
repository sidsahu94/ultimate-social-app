...
const ProfileEditModal = ({ isOpen, onClose, user }) => {
    ...
    // Initialize form including social links
	...
	const submit = async (e) => {
		...
		try {
            ...
            // Append social links individually or as a stringified object if your backend parser supports it.
            // Using dot notation for FormData which typical parsers (like Multer/BodyParser) expand.
